...
CFunction0ArgsSMC = $+1
	...
	ld b, 4
	mlt bc
	ld hl, CData2-CData+UserMem+5-4
	add hl, bc
	ld a, 0CDh
	jp InsertAHL														; call *
...
CFunction3Args:
	...
	ld (hl), e
	inc hl
_:	bit output_is_string, (iy+myFlags2)
	push af
		push hl
			ld hl, tempArg2
			ld (programPtr), hl
...
CSpriteNoClip:
	ld a, 59
_:	res arg1_is_small, (iy+myFlags4)
	res arg2_is_small, (iy+myFlags4)
	set arg3_is_small, (iy+myFlags4)
...
_:	res arg1_is_small, (iy+myFlags4)
	res arg2_is_small, (iy+myFlags4)
	set arg3_is_small, (iy+myFlags4)
	set arg4_is_small, (iy+myFlags4)
	set arg5_is_small, (iy+myFlags4)
	ld (CFunction5ArgsSMC), a
	call CFunction5Args
	bit output_is_number, (iy+myFlags)
	jp z, ErrorSyntax
	ld hl, (programPtr)
